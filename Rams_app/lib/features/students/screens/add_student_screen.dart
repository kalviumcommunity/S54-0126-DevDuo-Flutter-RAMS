...
class _AddStudentScreenState extends State<AddStudentScreen> {
  ...
  Future<void> _saveStudent() async {
    ...
    try {
      final student = Student(
        ...
        dateOfBirth:
            _dobController.text.trim().isNotEmpty ? _dobController.text : null,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _input('Full Name', 'John Doe', _nameController,
                        required: true,
                        validator: (v) =>
                            v == null || v.isEmpty ? 'Please enter student name' : null),
                    _input('Student ID', 'STD12345', _studentIdController,
                        required: true,
                        validator: (v) =>
                    ...
                    _input('Guardian Name', 'Jane Doe', _guardianNameController,
                        required: true,
                        validator: (v) => v == null || v.isEmpty
                            ? 'Please enter guardian name'
                            : null),
                    _input('Guardian Contact', '(123) 456-7890',
                        _guardianContactController,
                        required: true,
                        validator: (v) => v == null || v.isEmpty
                            ? 'Please enter guardian contact'
                            : null),
                    _dateInput('Enrollment Date', 'DD/MM/YYYY',
  ...
  Widget _dateInput(String label, String hint, TextEditingController controller) {
    return Padding(
